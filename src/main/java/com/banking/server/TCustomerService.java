...
public class TCustomerService {
  ...
  public interface AsyncIface {
    ...
    public void addAccountRequest(TCustomer tCustomer, AsyncMethodCallback resultHandler) throws TException;

    public void withdraw(String accountNumber, double amount, AsyncMethodCallback resultHandler) throws TException;

    public void sendMoney(String debitAccountNumber, String creditAccountNumber, double amount, AsyncMethodCallback resultHandler) throws TException;

    public void getAllTransactions(String accountNumber, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_addAccountRequest(TCustomer tCustomer) throws TException
    {
    ...
    public String recv_addAccountRequest() throws TException
    {
    ...
    public void send_withdraw(String accountNumber, double amount) throws TException
    {
    ...
    public String recv_withdraw() throws TException
    {
    ...
    public void send_sendMoney(String debitAccountNumber, String creditAccountNumber, double amount) throws TException
    {
    ...
    public void send_getAllTransactions(String accountNumber) throws TException
    {
    ...
    public List<TTransaction> recv_getAllTransactions() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class addAccountRequest_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TCustomer tCustomer;
      public addAccountRequest_call(TCustomer tCustomer, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class withdraw_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public withdraw_call(String accountNumber, double amount, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class sendMoney_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private double amount;
      public sendMoney_call(String debitAccountNumber, String creditAccountNumber, double amount, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class getAllTransactions_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String accountNumber;
      public getAllTransactions_call(String accountNumber, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.accountNumber = accountNumber;
      }
      ...
      public List<TTransaction> getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addAccountRequest<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addAccountRequest_args> {
      ...
      public addAccountRequest_result getResult(I iface, addAccountRequest_args args) throws TException {
        addAccountRequest_result result = new addAccountRequest_result();
    ...
    public static class withdraw<I extends Iface> extends org.apache.thrift.ProcessFunction<I, withdraw_args> {
      ...
      public withdraw_result getResult(I iface, withdraw_args args) throws TException {
        withdraw_result result = new withdraw_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addAccountRequest<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addAccountRequest_args, String> {
      public addAccountRequest() {
        super("addAccountRequest");
      }
      ...
      public void start(I iface, addAccountRequest_args args, AsyncMethodCallback<String> resultHandler) throws TException {
        iface.addAccountRequest(args.tCustomer,resultHandler);
      }
    }

    public static class withdraw<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, withdraw_args, String> {
      public withdraw() {
        super("withdraw");
      }
      ...
      public void start(I iface, withdraw_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class getAllTransactions<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAllTransactions_args, List<TTransaction>> {
      public getAllTransactions() {
        super("getAllTransactions");
      }
      ...
      public AsyncMethodCallback<List<TTransaction>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<TTransaction>>() { 
          public void onComplete(List<TTransaction> o) {
            getAllTransactions_result result = new getAllTransactions_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getAllTransactions_args args, AsyncMethodCallback<List<TTransaction>> resultHandler) throws TException {
  ...
  public static class addAccountRequest_args implements org.apache.thrift.TBase<addAccountRequest_args, addAccountRequest_args._Fields>, java.io.Serializable, Cloneable, Comparable<addAccountRequest_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new addAccountRequest_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addAccountRequest_argsTupleSchemeFactory());
    }

    public TCustomer tCustomer; // required
    ...
    public addAccountRequest_args setTCustomer(TCustomer tCustomer) {
      this.tCustomer = tCustomer;
      return this;
    }
    ...
    public int hashCode() {
      ...
      boolean present_tCustomer = true && (isSetTCustomer());
      list.add(present_tCustomer);
      if (present_tCustomer)
        list.add(tCustomer);
    ...
    public int compareTo(addAccountRequest_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetTCustomer()).compareTo(other.isSetTCustomer());
      if (lastComparison != 0) {
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("addAccountRequest_args(");
      boolean first = true;
    ...
    private static class addAccountRequest_argsStandardSchemeFactory implements SchemeFactory {
      public addAccountRequest_argsStandardScheme getScheme() {
        return new addAccountRequest_argsStandardScheme();
      }
    }

    private static class addAccountRequest_argsStandardScheme extends StandardScheme<addAccountRequest_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, addAccountRequest_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addAccountRequest_args struct) throws TException {
        struct.validate();
    ...
    private static class addAccountRequest_argsTupleSchemeFactory implements SchemeFactory {
      public addAccountRequest_argsTupleScheme getScheme() {
        return new addAccountRequest_argsTupleScheme();
      }
    }

    private static class addAccountRequest_argsTupleScheme extends TupleScheme<addAccountRequest_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, addAccountRequest_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, addAccountRequest_args struct) throws TException {
  ...
  public static class addAccountRequest_result implements org.apache.thrift.TBase<addAccountRequest_result, addAccountRequest_result._Fields>, java.io.Serializable, Cloneable, Comparable<addAccountRequest_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new addAccountRequest_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addAccountRequest_resultTupleSchemeFactory());
    }
    ...
    public addAccountRequest_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addAccountRequest_result(");
      boolean first = true;
    ...
    private static class addAccountRequest_resultStandardSchemeFactory implements SchemeFactory {
      public addAccountRequest_resultStandardScheme getScheme() {
        return new addAccountRequest_resultStandardScheme();
      }
    }

    private static class addAccountRequest_resultStandardScheme extends StandardScheme<addAccountRequest_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, addAccountRequest_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addAccountRequest_result struct) throws TException {
        struct.validate();
    ...
    private static class addAccountRequest_resultTupleSchemeFactory implements SchemeFactory {
      public addAccountRequest_resultTupleScheme getScheme() {
        return new addAccountRequest_resultTupleScheme();
      }
    }

    private static class addAccountRequest_resultTupleScheme extends TupleScheme<addAccountRequest_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, addAccountRequest_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, addAccountRequest_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class withdraw_args implements org.apache.thrift.TBase<withdraw_args, withdraw_args._Fields>, java.io.Serializable, Cloneable, Comparable<withdraw_args>   {
    ...
    public withdraw_args setAccountNumber(String accountNumber) {
      this.accountNumber = accountNumber;
      return this;
    }
    ...
    private static class withdraw_argsStandardScheme extends StandardScheme<withdraw_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, withdraw_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, withdraw_args struct) throws TException {
        struct.validate();
    ...
    private static class withdraw_argsTupleScheme extends TupleScheme<withdraw_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, withdraw_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, withdraw_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
  ...
  public static class withdraw_result implements org.apache.thrift.TBase<withdraw_result, withdraw_result._Fields>, java.io.Serializable, Cloneable, Comparable<withdraw_result>   {
    ...
    public withdraw_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    private static class withdraw_resultStandardScheme extends StandardScheme<withdraw_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, withdraw_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, withdraw_result struct) throws TException {
        struct.validate();
    ...
    private static class withdraw_resultTupleScheme extends TupleScheme<withdraw_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, withdraw_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, withdraw_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class sendMoney_args implements org.apache.thrift.TBase<sendMoney_args, sendMoney_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendMoney_args>   {
    ...
    public sendMoney_args setDebitAccountNumber(String debitAccountNumber) {
      this.debitAccountNumber = debitAccountNumber;
      return this;
    }
    ...
    public sendMoney_args setCreditAccountNumber(String creditAccountNumber) {
      this.creditAccountNumber = creditAccountNumber;
      return this;
    }
  ...
  public static class getAllTransactions_args implements org.apache.thrift.TBase<getAllTransactions_args, getAllTransactions_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAllTransactions_args>   {
    ...
    public getAllTransactions_args setAccountNumber(String accountNumber) {
      this.accountNumber = accountNumber;
      return this;
    }
  ...
  public static class getAllTransactions_result implements org.apache.thrift.TBase<getAllTransactions_result, getAllTransactions_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAllTransactions_result>   {
    ...
    public List<TTransaction> success; // required
    ...
    public getAllTransactions_result(getAllTransactions_result other) {
      if (other.isSetSuccess()) {
        List<TTransaction> __this__success = new ArrayList<TTransaction>(other.success.size());
    ...
    public void addToSuccess(TTransaction elem) {
      if (this.success == null) {
        this.success = new ArrayList<TTransaction>();
      }
      this.success.add(elem);
    }

    public List<TTransaction> getSuccess() {
      return this.success;
    }

    public getAllTransactions_result setSuccess(List<TTransaction> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<TTransaction>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TTransaction>(_list16.size);
                  TTransaction _elem17;
                  for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                  {
                    _elem17 = new TTransaction();
                    _elem17.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllTransactions_result struct) throws TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TTransaction _iter19 : struct.success)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TTransaction _iter20 : struct.success)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TTransaction>(_list21.size);
            TTransaction _elem22;
            for (int _i23 = 0; _i23 < _list21.size; ++_i23)
            {
              _elem22 = new TTransaction();
              _elem22.read(iprot);
